...
import com.intellect.dao.UserDao;
...
//	}
	@RequestMapping("saveupdate")
	public ModelAndView saveUpdate(@ModelAttribute("user") User user, ModelAndView mv, @RequestParam("pic") MultipartFile file) throws IOException{
		System.out.println("In Save User");
		byte[] userPic = file.getBytes();
